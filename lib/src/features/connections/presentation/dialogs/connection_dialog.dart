...
class _ConnectionDialogState extends State<ConnectionDialog> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _sshPortController = TextEditingController(text: c?.sshPort?.toString() ?? '22');
    ...
    _sshKeyPasswordController = TextEditingController(text: c?.sshKeyPassword ?? '');
  ...
  Future<void> _pickKeyFile() async {
      ...
      if (file != null) {
          setState(() {
              _sshKeyPathController.text = file.path;
          });
      }
  }
